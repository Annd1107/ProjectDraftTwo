...
const translations: Record<Language, Record<string, string>> = {
  mn: {
    ...
    "about.missionText": "TemtseenPortal нь Монголын сурагчдад олимпиад, тэмцээнд хялбархан бүрт��үүлэх боломжийг олгохоор зорьж байна. Бид боловсролын салбарт дижитал шийдлээр дэмжлэг үзүүлж, сурагчдын ур чадварыг хөгжүүлэхэд хувь нэмэр оруулж байна.",
